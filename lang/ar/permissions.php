...
return [
    'labels' => [
        ...
        'stock_movements.purge' => 'مسح سجل حركات المستودع',
    ...
    'hints' => [
        ...
        'stock_movements.purge' => 'خطير: يحذف نهائياً كامل سجل حركات المستودع (الكاردكس)؛ يبقى المخزون الحالي دون تغيير.',
        'activity.purge'  => 'يحذف صفوف سجل التغييرات القديمة لإبقاء قاعدة البيانات خفيفة؛ لا يؤثر على المخزون أو الأصناف.',
    ],
