...
return [
    ...
    'actions' => [
        ...
        'stocktake_cancelled' => 'Inventur abgebrochen',
        'stocktake_applied' => 'Inventur angewendet',
        ...
        'backup_created' => 'Sicherung erstellt', 'backup_restored' => 'Sicherung wiederhergestellt', 'backup_deleted' => 'Sicherung gelöscht', 'stock_movements_purged' => 'Bewegungsprotokoll gelöscht', 'system_model_duplicated' => 'Systemmodell dupliziert', 'system_version_duplicated' => 'Systemversion dupliziert',
    ],
    'subjects' => [
