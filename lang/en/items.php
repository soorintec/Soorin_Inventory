...
return [
    ...
    'specs_section'      => 'Technical specifications',
    'specs_section_hint' => 'For items that have a parts/spec list (e.g. a computer case). Optional.',
    'has_specs'          => 'This item has technical specs',
    'has_specs_hint'     => 'Turn on to enable a technical-spec table for this item.',
    'specs_table'        => 'Technical spec table',
    'specs_add_row'      => 'Add row',
    'spec_row_label'     => 'Label',
    'spec_row_label_ph'  => 'e.g. CPU',
    'spec_row_value'     => 'Value',
    'spec_row_value_ph'  => 'e.g. Intel Core i7',
    'specs_label'        => 'Technical specs',
    'specs_empty'        => 'No technical specs recorded.',
