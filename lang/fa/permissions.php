...
return [
    'labels' => [
        ...
        'stock_movements.purge' => 'پاک‌سازیِ لاگِ تراکنش‌های انبار',
    ...
    'hints' => [
        ...
        'stock_movements.purge' => 'خطرناک: کلِ سابقهٔ حرکت‌های انبار (کاردکس) را برای همیشه پاک می‌کند؛ موجودیِ فعلی دست‌نخورده می‌ماند.',
    ],
