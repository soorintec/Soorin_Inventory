...
return [
    ...
    'purge_activity_label' => 'Purger l\'ancien journal d\'activité',
    'purge_activity_heading' => 'Purger le journal d\'activité',
    'purge_activity_warning' => 'Les anciennes lignes du journal d\'activité sont supprimées définitivement pour alléger la base de données. Cette action est irréversible et sans effet sur le stock ou les articles.',
    'purge_activity_age_label' => 'Quelles lignes supprimer ?',
    'purge_activity_age_3' => 'Plus de 3 mois',
    'purge_activity_age_6' => 'Plus de 6 mois',
    'purge_activity_age_12' => 'Plus de 12 mois',
    'purge_activity_age_all' => 'Tout le journal (le vider entièrement)',
    'purge_activity_confirm' => 'Oui, purger',
    'purge_activity_done' => ':count lignes de journal supprimées.',
    'purge_activity_none' => 'Il n\'y avait rien à supprimer.',
    'create_business' => 'Sauvegarder une entreprise',
    'create_business_hint' => 'Seules les données de l\'entreprise choisie sont sauvegardées (pas tout le système).',
    'which_business' => 'Quelle entreprise ?',
    'business_not_found' => 'Entreprise introuvable.',
    'restore_target' => 'Restaurer dans ?',
    'restore_target_hint' => 'Complet : tout le système. Ou une seule entreprise (le fichier doit être la sauvegarde de cette entreprise).',
    'restore_target_full' => 'Complet (toutes les entreprises)',
