...
return [
    'labels' => [
        ...
        'warehouses.manage' => 'Crea e gestisci magazzini', 'stocktakes.manage' => 'Inventario', 'stock_movements.purge' => 'Svuota il registro movimenti',
        ...
        'users.view' => 'Visualizza utenti', 'users.manage' => 'Crea e modifica utenti', 'businesses.manage' => 'Gestisci attività',
        'settings.manage' => 'Impostazioni di sistema', 'activity.view' => 'Visualizza registro attività', 'activity.purge' => 'Svuota il registro attività',
    ...
    'hints' => [
        ...
        'stock_movements.purge' => 'Pericoloso: elimina definitivamente tutta la cronologia dei movimenti di magazzino (kardex); la giacenza attuale resta intatta.',
        'activity.purge' => 'Elimina le vecchie righe del registro attività per mantenere leggero il database; nessun effetto su giacenze o articoli.',
