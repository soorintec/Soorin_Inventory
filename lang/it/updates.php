...
return [
    ...
    'rollback_heading' => 'Torna alla versione precedente',
    'rollback_warning' => 'Il codice dell\'app tornerà alla versione :version (prima dell\'ultimo aggiornamento). Prima viene creato un backup aggiornato dello stato attuale, così anche questo ripristino è reversibile. Scegli cosa fare con il database:',
    'rollback_db_label' => 'Cosa fare con il database?',
    'rollback_db_restore' => 'Ripristino completo — riporta anche il database a prima dell\'aggiornamento',
    'rollback_db_restore_hint' => 'Del tutto coerente e sicuro. I dati inseriti dopo l\'aggiornamento vengono persi (ma restano nel backup pre-ripristino).',
    'rollback_db_keep' => 'Solo codice — lascia il database intatto',
    'rollback_db_keep_hint' => 'I nuovi dati vengono mantenuti. Sicuro solo se l\'aggiornamento più recente non ha modifiche distruttive dello schema.',
    'rollback_confirm_button' => 'Sì, torna indietro',
    'rollback_done' => 'Tornato alla versione :version.',
    'rollback_failed' => 'Ripristino non riuscito.',
    'rollback_none' => 'Nessun punto di ripristino registrato (non hai ancora aggiornato da questo pannello).',
    'rollback_backup_note' => 'Backup pre-ripristino: :file',
];
