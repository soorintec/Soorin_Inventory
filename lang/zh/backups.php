...
return [
    ...
    'purge_activity_label' => '清理旧的变更日志',
    'purge_activity_heading' => '清理变更日志',
    'purge_activity_warning' => '旧的变更日志行将被永久删除，以保持数据库轻量。此操作不可撤销，且不影响库存或物料。',
    'purge_activity_age_label' => '删除哪些行？',
    'purge_activity_age_3' => '早于 3 个月',
    'purge_activity_age_6' => '早于 6 个月',
    'purge_activity_age_12' => '早于 12 个月',
    'purge_activity_age_all' => '整个日志（全部清空）',
    'purge_activity_confirm' => '是的，清理',
    'purge_activity_done' => '已删除 :count 行日志。',
    'purge_activity_none' => '没有可删除的内容。',
    'create_business' => '备份单个业务',
    'create_business_hint' => '仅备份所选业务的数据（不是整个系统）。',
    'which_business' => '哪个业务？',
    'business_not_found' => '未找到业务。',
    'restore_target' => '恢复到？',
    'restore_target_hint' => '完整：整个系统。或单个业务（文件必须是该业务的备份）。',
    'restore_target_full' => '完整（所有业务）',
    ...
    'sched_weekday' => '星期',
    'sched_monthday' => '每月日期',
    'sched_monthday_hint' => '介于 1 到 31 之间 — 如果当月较短，则为当月最后一天。',
    'sched_time' => '时间（德黑兰时间）',
    ...
    'scheduler_dead_hint' => '如果出现 “Unit … does not exist”，说明计时器未安装；请在服务器上执行：sudo bash deploy/install-scheduler.sh',
    'scheduler_heartbeat' => '最近心跳',
    'on_disable_label' => '如何处理已保存的网络设置？',
    'on_disable_keep' => '保留（下次无需重新输入）',
    'on_disable_clear' => '删除',
];
