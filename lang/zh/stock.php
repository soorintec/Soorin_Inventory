...
return [
    ...
    'purge_label'          => '清空整个日志',
    'purge_heading'        => '清空整个仓库交易日志',
    'purge_warning'        => '此日志的所有行将被永久删除，卡片账历史和过往流水报表将丢失。当前库存和物料成本保持不变。此操作不可撤销。',
    'purge_confirm_button' => '是的，清空整个日志',
    'purge_done'           => '已删除 :count 笔交易。',

    'remove_done' => '已从仓库移除 :count 项。',
    'delete_selected_warning' => '每行仅从其所属仓库移除；在其他仓库仍有库存的物料在那里保持不变，只有当它在任何仓库都不存在时才会被完全删除。剩余的可用库存将以“调整”方式出库。是否继续？',
    'delete_item_from_warehouse_warning' => '此物料将仅从“:warehouse”仓库移除；在其他仓库保持不变。如果本仓库仍有可用库存，将以“调整”方式出库。是否继续？',
    'transfer_item' => '转移到其他仓库',
    'transfer_selected_items' => '将所选转移到其他仓库',
    'transfer_target' => '目标仓库',
    'transfer_remove_source' => '同时从来源仓库移除物料名称',
    'transfer_remove_source_hint' => '开：转移后，物料的空行也会从来源仓库移除。关：仅转移库存，物料以零库存保留在来源仓库。',
    'transfer_done' => '已将 :count 项转移到“:warehouse”仓库。',
    'transfer_none' => '没有可转移的项（可能没有可用库存，或已在目标仓库）。',
