...
class LoginTest extends TestCase
{
    ...
    private function user(array $attrs = []): User
    {
        return User::create(array_merge([
            'name' => 'کاربر تست', 'email' => 'test@dpst.ir', 'mobile' => '09121234567',
    ...
    {
        $user = $this->user();
        $this->assertSame($user->id, (new LoginAttempt('test@dpst.ir', 'secret123'))->authenticate()->id);
    }
    ...
    public function test_wrong_password_is_rejected(): void
    {
        ...
        (new LoginAttempt('test@dpst.ir', 'wrong'))->authenticate();
    }
